...
Claude와 함께 진행하는 **모든 작업**은 반드시 해당 작업 날짜의 로그 파일에 기록합니다.

### 로그 파일 위치
- `docs/logs/{YYYY-MM-DD}.log`
- 예: `docs/logs/2025-12-28.log`
- **중요**: 반드시 오늘 날짜의 로그 파일에 작성할 것. 다른 날짜의 로그 파일을 수정하지 않음.

### 로그 작성 대상 (모든 작업)
- 코드 작성 및 수정
- 트러블슈팅, 버그 수정
- 리팩토링
- 설정 파일 변경 (Docker, application.yml 등)
- 테스트 코드 작성
- 문서 작성 및 수정

### 로그 작성 시점
- 의미있는 작업이 완료될 때마다 즉시 기록
- 사용자가 요청할 때
- 대화 세션이 종료되기 전 (필수)
